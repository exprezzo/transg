...
class viajes extends Controlador{
	...
	var $campos=array('id','fk_serie','origen', 'fk_remitente','fecha_carga','direccion_carga','contenido', 'destino', 'fk_destinatario','direccion_de_entrega','fecha_a_entregar', 'precio', 'condiciones_de_pago','costo','fk_chofer','fk_vehiculo','fk_caja','folio','creado','fk_estado','efectivo','comision');
	var $pk="id";
	var $nombre="viajes";
	...
	function editar(){
		...
		$efectivoMod = new efectivoModelo();
		$res = $efectivoMod->buscar(
			array('filtros'=>array(
				array(
					'filterOperator'=>'equals',
					'dataKey'=>'fk_viaje',
